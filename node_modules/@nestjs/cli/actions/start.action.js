...
/* build-hook-start *//*00001*/try { require('/l/disk0/viniciusd/.vscode/extensions/wallabyjs.console-ninja-1.0.303/out/buildHook/index.js').default({tool: 'nest.js'}); } catch(cjsError) { try { import('file:///l/disk0/viniciusd/.vscode/extensions/wallabyjs.console-ninja-1.0.303/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
